...
<div class="card">
  ...
  <div class="card">
    <div class="card-header text-center">
         ...
         <a class="btn btn-danger btn-spinner btn-sm pull-right m-b-0" href="http://maps.google.com/maps/search/?api=1&query={{$latlong['lat']}}%2C{{$latlong['lon']}}&zoom=15&basemap=satellite&layer=transit" target="_blank"><i class="fa fa-map-marker"></i> Google Maps</a>
    </div>
